...
const Compare = () => {
  ...
  const handleCompare = (event) => {
    ...
    const selectedCountry1 = countries.find(
      (country) => country.id == selectedOption1
    );
    const selectedCountry2 = countries.find(
      (country) => country.id == selectedOption2
    );
    ...
    <div>
        ...
        <div className="table__container">
          <table class="comparison-table">
            ...
            <tbody>
              <tr>
                <td>Country Name</td>
                <td align="center">{countryOne.country_name}</td>
                <td align="center" >{countryTwo.country_name}</td>
              </tr>
              <tr>
                <td>Start Date</td>
                <td align="center">{countryOne.start_date}</td>
                <td align="center">{countryTwo.start_date}</td>
              </tr>
              <tr>
                <td>History</td>
              ...
              <tr>
                <td>E-Passport</td>
                <td class="boolean">
                  {countryOne.epassport == 1 ? "Yes" : "NO"}
                </td>
                <td class="boolean">
                  {countryTwo.epassport == 1 ? "Yes" : "NO"}
                </td>
              </tr>
              <tr>
                <td>Birth Death Cert</td>
                <td class="boolean">
                  {countryOne.birthdeathcert == 1 ? "Yes" : "NO"}
                </td>
                <td class="boolean">
                  {countryTwo.birthdeathcert == 1 ? "Yes" : "NO"}
                </td>
              </tr>
              <tr>
                <td>Water Payment</td>
                <td class="boolean">
                  {countryOne.water_payment == 1 ? "Yes" : "NO"}
                </td>
                <td class="boolean">
                  {countryTwo.water_payment == 1 ? "Yes" : "NO"}
                </td>
              </tr>
              <tr>
                <td>Electricity Payment</td>
                <td class="boolean">
                  {countryOne.electricity_payment == 1 ? "Yes" : "NO"}
                </td>
                <td class="boolean">
                  {countryTwo.electricity_payment == 1 ? "Yes" : "NO"}
                </td>
              </tr>
              <tr>
                <td>Mobile Services</td>
                <td className="boolean">
                  {countryOne.mobile_services == 1 ? "Yes" : "NO"}
                </td>
                <td className="boolean">
                  {countryTwo.mobile_services == 1 ? "Yes" : "NO"}
                </td>
              </tr>
              <tr>
                <td>Blockchain Adoption</td>
                <td class="boolean">
                  {countryOne.Blockchain_adoption == 1 ? "Yes" : "NO"}
                </td>
                <td class="boolean">
                  {countryTwo.Blockchain_adoption == 1 ? "Yes" : "NO"}
                </td>
              </tr>
              <tr>
                <td>Electronic Voting</td>
                <td class="boolean">
                  {countryOne.electronic_voting == 1 ? "Yes" : "No"}
                </td>
                <td class="boolean">
                  {countryTwo.electronic_voting == 1 ? "Yes" : "No"}
                </td>
              </tr>
            </tbody>
          </table>
      ...
      {compareResult &&
        (countryOne.featureCount > countryTwo.featureCount ? (
          <>
            <h1 className="header-country-result">
              Country One has better E governance
            </h1>
          </>
        ) : (
          <>
            <h1 className="header-country-result">
              Country Two has better E governance
            </h1>
          </>
        ))}
    </div>
